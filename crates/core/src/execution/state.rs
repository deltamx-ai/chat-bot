...
pub fn ensure_step_transition(
    ...
    let allowed = matches!(
        ...
        (StepStatus::Pending, StepStatus::Ready)
            ...
            | (StepStatus::Ready, StepStatus::AwaitingConfirmation)
            | (StepStatus::Ready, StepStatus::AwaitingInput)
            | (StepStatus::Ready, StepStatus::Skipped)
            | (StepStatus::Ready, StepStatus::Cancelled)
            | (StepStatus::AwaitingConfirmation, StepStatus::Running)
            | (StepStatus::AwaitingConfirmation, StepStatus::Cancelled)
            | (StepStatus::AwaitingInput, StepStatus::Running)
            | (StepStatus::AwaitingInput, StepStatus::Cancelled)
